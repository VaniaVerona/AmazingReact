...
function Table({ eventsData }) {
  ...
  function calcularCategoriasEstadisticasPasadas(events) {
    const categories = [];
  ...
  const { categories, categoryRevenues, categoryAssistance, categoryCapacity } = calcularCategoriasEstadisticasPasadas(eventsData);

  function calcularCategoriasestadisticasFuturas(events) {
    const categories = [];
    const categoryRevenues = [];
  ...
  const { categories: futureCategories, categoryRevenues: futureRevenues, categoryEstimates, categoryCapacity: futureCapacity } = calcularCategoriasestadisticasFuturas(eventsData);
